...
import { PatientsAgeGroupKpiClient } from "../../services/KpisService";
import { CACHE_KEY_Agegroup } from "../../constants";
import LoadingSpinner from "../LoadingSpinner";
import { useMemo } from "react";
ChartJS.register(ArcElement, Tooltip, Legend);
const PatientAgeGroupKpi = () => {
    const { data: age, isLoading } = getGlobal({}, CACHE_KEY_Agegroup, PatientsAgeGroupKpiClient, { staleTime: 360000 });
    const options = {
        layout: {
            padding: {
                bottom: 2,
