...
import { CACHE_KEY_xrayCategory, CACHE_KEY_XrayPreferences, } from "../../constants";
import addGlobal from "../../hooks/addGlobal";
import LoadingSpinner from "../LoadingSpinner";
import DeleteOutlineOutlinedIcon from "@mui/icons-material/DeleteOutlineOutlined";
import { categoryXrayApiClient, deleteCategoryApiClient, } from "../../services/XrayService";
const XraySettings = () => {
    const { showSnackbar } = useSnackbarStore();
    const { data, refetch, isLoading } = getGlobal({}, CACHE_KEY_XrayPreferences, XrayPreferenceApiClient, undefined);
    const { data: categorys, isLoading: isLoading2, refetch: refetch2, } = getGlobal({}, CACHE_KEY_xrayCategory, categoryXrayApiClient, undefined);
    ...
    return (_jsxs(Box, { className: "flex flex-col w-full h-full p-4 gap-4", component: "form", onSubmit: handleSubmit(onSubmit), children: [_jsx("p", { className: "font-light text-gray-600 text-md md:text-xl text-center", children: "Ajouter une radiographie" }), _jsx("p", { className: " text-start font-thin  text-sm md:text-lg", children: "Entrez les d\u00E9tails de la paraclinique." }), _jsxs(Box, { className: " flex flex-col md:flex-row gap-4 flex-wrap ", children: [_jsxs(Box, { className: "w-full flex flex-col gap-2 md:flex-row md:flex-wrap items-center ", children: [_jsx("label", { htmlFor: "nom", className: "w-full md:w-[160px]", children: "Cat\u00E9gorie:" }), _jsx(FormControl, { className: "w-full md:flex-1", children: _jsx(Controller, { name: "xray_category", control: control, render: ({ field }) => (_jsx(Autocomplete, { freeSolo: true, options: categorys ?? [], value: typeof field.value === "string"
                                            ? field.value
                                            ...
                                            _jsxs("div", { className: "flex justify-between items-center w-full", children: [_jsx("span", { children: typeof option === "string" ? option : option.name }), typeof option !== "string" && (_jsx(IconButton, { size: "small", color: "error", onClick: (event) => {
                                                        ...
                                                        }, children: _jsx(DeleteOutlineOutlinedIcon, {}) }))] }))), renderInput: (params) => (_jsx(TextField, { ...params, variant: "outlined", placeholder: "S\u00E9lectionnez ou saisissez une cat\u00E9gorie" })), noOptionsText: "Aucune cat\u00E9gorie disponible" })) }) })] }), _jsxs(Box, { className: "w-full flex flex-col gap-2 md:flex-row md:flex-wrap items-center ", children: [_jsx("label", { htmlFor: "nom", className: "w-full md:w-[160px]", children: "Radiographie:" }), _jsx(FormControl, { className: "w-full md:flex-1", children: _jsx(Controller, { defaultValue: "", name: "xray_type", control: control, render: ({ field }) => (_jsx(TextField, { ...field, id: "xray_type", label: "Radiographie" })) }) })] }), _jsxs(Box, { className: "w-full flex flex-col gap-2 md:flex-row md:flex-wrap items-center", children: [_jsx("label", { htmlFor: "price", className: "w-full md:w-[160px]", children: "Prix:" }), _jsx(FormControl, { className: "w-full md:flex-1", children: _jsx(Controller
                                //@ts-ignore
                                , { 
                                    //@ts-ignore
                                    defaultValue: 0.0, name: "price", control: control, render: ({ field }) => (_jsx(TextField, { ...field, id: "price", type: "number", label: "Prix" })) }) })] }), _jsx(Box, { className: "flex ml-auto mt-4", children: _jsx(Button, { type: "submit", variant: "contained", className: "w-full md:w-max !px-8 !py-2 rounded-lg ", children: "Ajouter" }) })] }), _jsx(TableContainer, { className: "w-full max-h-[400px] flex-wrap overflow-auto border border-gray-300", children: _jsxs(Table, { "aria-label": "simple table", children: [_jsx(TableHead, { children: _jsxs(TableRow, { className: "bg-gray-300 !rounded-2xl\tsticky top-0 z-10", children: [_jsx(TableCell, { children: _jsx("strong", { children: "Nom de la cat\u00E9gorie" }) }), _jsx(TableCell, { children: _jsx("strong", { children: "Nom de la radiographie" }) }), _jsx(TableCell, { children: _jsx("strong", { children: "Prix" }) }), _jsx(TableCell, { className: "w-20" })] }) }), _jsx(TableBody, { children: data?.map((xray, index) => (_jsxs(TableRow, { children: [_jsx(TableCell, { children: xray.category }), _jsx(TableCell, { children: xray.xray_type }), _jsxs(TableCell, { children: [xray.price, " MAD"] }), _jsx(TableCell, { className: "w-20", children: _jsx(Button, { onClick: () => onDelete(xray.id), className: "w-max mx-auto", variant: "outlined", color: "error", disabled: xray.id === undefined, children: _jsx(DeleteOutlineIcon, {}) }) })] }, index))) })] }) })] }));
};
